...
class RegistrarUsuarioView(MyView, View):
    def get(self, request):
        ...
        return render(request, 'registrar_professor.html', {'form': form, 'usuarios': usuarios, 'logado': logado})
    ...
    def post(self, request):
        ...
        if (form.is_valid()):
            ...
            return render(request, 'registrar_professor.html', {'form': form, 'mensagem': mensagem, 'usuarios': usuarios, 'logado': logado })

        return render(request, 'registrar_professor.html', {'form': form, 'usuarios': usuarios})
...
def gerar_senha(request, usuario_id):
    ...
    return render(request, 'registrar_professor.html', {'form': form, 'usuarios':usuarios, 'mensagem': mensagem, 'logado': logado })
